...
// Bump whenever hero.mp4 / hero-poster.jpg are re-encoded — these assets
// are cached (Cache-Control max-age=86400), so without a version bump a
// browser or CDN edge that already fetched the old bytes would keep
// serving them under the same URL for up to a day after a fix ships.
